...
#define DEBUG_SERVO                   0 //    OFF, n. Where n=1 to 9 as the designated axis for logging servo activity.     Option
...
#define SERIAL_DEBUG_BAUD          115200 // 230400, n. Where n=9600,19200,576cd .00,115200,230400,460800 (common baud rates.)    Option
